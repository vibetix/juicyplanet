    ...
    <section className="py-20 bg-gradient-to-r from-juicy-red/10 via-juicy-yellow/10 to-juicy-green/10 relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          {/* Header */}
          <div className="mb-12">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-raleway font-bold text-gray-800 mb-4">
              Stay <span className="text-juicy-red">Juicy</span> with Us!
            </h2>
            <p className="text-lg sm:text-xl text-gray-600 font-quicksand leading-relaxed">
          ...
          <form onSubmit={handleSubmit} className="max-w-2xl mx-auto mb-12">
            <div className="flex flex-col sm:flex-row gap-4 p-3 bg-white rounded-full shadow-2xl">
              <Input
                type="email"
                placeholder="Enter your email for juicy updates..."
                value={email}
                onChange={(e) => setEmail(e.target.value)}
                className="flex-1 border-0 bg-transparent text-base sm:text-lg font-quicksand placeholder:text-gray-400 focus-visible:ring-0"
                required
              />
              <Button
                type="submit"
                disabled={isLoading}
                className="bg-juicy-red hover:bg-juicy-red-light text-white font-quicksand font-semibold px-6 sm:px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="flex items-start sm:items-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="text-sm text-gray-600 font-quicksand">
                  Be first to try our latest creations
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start sm:items-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="text-sm text-gray-600 font-quicksand">
                  Expert nutrition and health advice
                </div>
              </div>
            </div>
          </div>
