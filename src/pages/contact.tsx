    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 py-16 px-4 sm:px-6 lg:px-8 container mx-auto max-w-5xl space-y-12 pt-[80px]">
        ...
        <section className="space-y-2">
          <h2 className="text-2xl font-raleway font-bold text-center text-gray-800">Our Location</h2>
          <div className="rounded-lg overflow-hidden shadow-md">
            <iframe
              ...
              allowFullScreen
              loading="lazy"
              src={`https://www.google.com/maps/embed/v1/place?q=Accra,Ghana&key=YOUR_GOOGLE_MAPS_API_KEY`}
            ></iframe>
          </div>
        </section>
      </main>
